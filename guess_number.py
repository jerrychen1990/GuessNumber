...
"""
-------------------------------------------------
   File Name：     guess_number.py
   Author :       chenhao
   time：          2021/10/18 16:34
   Description :
-------------------------------------------------
"""
import collections
...
if __name__ == '__main__':
    ...
    # rnd_player = RandomPlayer("random_player")
    # human = Human("human")
    # tree_player = TreePlayer("tree_player", wait=2)
    #
    # # run_game(tree_player, rnd=10)
    # players = [human, tree_player]
    #
